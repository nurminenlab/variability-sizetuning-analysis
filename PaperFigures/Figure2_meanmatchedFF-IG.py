...
axes[this_row,this_col].set_ylim([30,65])
...
axes[this_row,this_col].set_ylim([0.5,3.5])
...
axes[this_row,this_col].set_ylim([30,70])
axes[this_row,this_col].set_ylabel('Firing rate (Hz)')
...
if save_figures:
    plt.savefig(fig_dir+'IG-mean-matched-PSTHs.svg')
