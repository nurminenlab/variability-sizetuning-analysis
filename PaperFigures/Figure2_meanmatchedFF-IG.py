...
if save_figures:
    plt.savefig(fig_dir+'F2-IG-mean-matched-PSTHs.svg')
...
if save_figures:
    plt.savefig(fig_dir+'F2-IG-mean-matched-averages-SMLRF.svg')
...
if save_figures:
    plt.savefig(fig_dir+'F2-IG-mean-matched-averages-RFLAR.svg')
