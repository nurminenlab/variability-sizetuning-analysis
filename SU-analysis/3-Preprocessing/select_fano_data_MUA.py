...
outfile = 'selectedData_MUA_lenient_400ms_macaque_July-2020.pkl'
...
for data_table in tables_list:
    ...
    for neuron in range(spkC_NoL.shape[0]):
        ...
        selectedData[pp]['info'] = {'diam':diam,'layer':layer[neuron],'animal':animal[neuron],'penetr':penetr[neuron]}
        pp += 1
