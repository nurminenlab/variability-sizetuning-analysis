...
plt.figure()
ax = plt.subplot(1,2,1)
sns.swarmplot(x='layer',y='RFnormed_maxquench_diam',data=amplification_DF,color='blue',ax=ax)
sns.swarmplot(x='layer',y='RFnormed_maxamplif_diam',data=amplification_DF,color='orange',ax=ax)
ax.set_yscale('log')
