...
with open(S_dir + 'mean_PSTHs_IG-MK-MU.pkl','rb') as f:
...
plt.figure(1)
plt.savefig(fig_dir + 'F1_IG_PSTH_fanoPSTH.eps',bbox_inches='tight',pad_inches=0)        
plt.figure(2)
plt.savefig(fig_dir + 'F1_IG_fano-PSTH-zoomed.eps',bbox_inches='tight',pad_inches=0)
plt.figure(3)
...
plt.figure(4)
plt.savefig(fig_dir + 'F1_IG_ASFs.eps',bbox_inches='tight',pad_inches=0)
