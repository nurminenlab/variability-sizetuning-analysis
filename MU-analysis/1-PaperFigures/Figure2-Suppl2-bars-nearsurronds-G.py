...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-G-mean-matched-PSTHs-nearSURROUND.svg')
...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-G-mean-matched-nearSURROUND.svg')
...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-G-RFvs26-mean-matched-nearSURROUND.svg')
