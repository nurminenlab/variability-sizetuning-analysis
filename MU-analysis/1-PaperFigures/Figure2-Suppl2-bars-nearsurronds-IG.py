...
def fit_mean_response(meanR,diam):
    ...
    nearSUR4_idx = np.argmin(np.abs(3*RF_diam - diam))
...
axes[this_row,this_col].set_ylim([0.5,2.5])
...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-IG-RFvs26-mean-matched-nearSURROUND.svg')
