...
print('\n0.1/0.2 vs RF')
print('SG: 0.1/0.2'+ ' mean: ' + str(np.mean(FA_SML)) + ' se: ' + str(SML_error))
print('SG: RF'+ ' mean: ' + str(np.mean(FA_RF)) + ' se: ' + str(RF_error)) 
print('p-value: ', p_SML)
...
print('\nRF vs 2*RF')
print('SG: RF'+ ' mean: ' + str(np.mean(FA_RF2)) + ' se: ' + str(RF2_error))
print('SG: 2*RF'+ ' mean: ' + str(np.mean(FA_SUR2)) + ' se: ' + str(SUR2_error)) 
...
print('\nRF vs 4*RF')
print('SG: RF'+ ' mean: ' + str(np.mean(FA_RF3)) + ' se: ' + str(RF3_error))
print('SG: 4*RF'+ ' mean: ' + str(np.mean(FA_SUR3)) + ' se: ' + str(SUR3_error)) 
...
print('\nRF vs 26')
print('SG: RF'+ ' mean: ' + str(np.mean(FA_RF_LAR)) + ' se: ' + str(RF_LAR_error))
print('SG: 26'+ ' mean: ' + str(np.mean(FA_LAR)) + ' se: ' + str(LAR_error)) 
print('p-value: ', p_LAR)

if save_figures:
    plt.savefig(fig_dir+'SG-FA-meanmatch.svg')
