...
axes[this_row,this_col].set_ylim([0,80])
...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-IG-mean-matched-PSTHs-SMLvsRF.svg')
...
if save_figures:
    plt.savefig(fig_dir+'Figure2-Suppl-2-IG-mean-matched-SMLvsRF.svg')
