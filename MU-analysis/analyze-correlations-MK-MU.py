...
plt.figure(num='baseline vs SUR')
ax = plt.subplot(111)
sns.scatterplot(x='gm_fit_correlation_BSL',y='gm_fit_correlation_SUR',hue='layer_type',data=params_df,ax=ax, s=8)
ax.plot([-1,1],[-1,1],'k-')
ax.set_xlim(-0.2,1)
ax.set_ylim(-0.2,1)
ax.set_aspect('equal')

plt.figure(num='baseline vs LAR')
ax = plt.subplot(111)
...
plt.figure(24)
SEM = params_df[['gm_fit_correlation_BSL','gm_fit_correlation_RF','gm_fit_correlation_SUR','gm_fit_correlation_LAR']].sem()
ax = plt.subplot(1,1,1)
