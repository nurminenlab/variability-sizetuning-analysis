...
# save data
params_df.to_csv(S_dir+'extracted_params-Dec-2021-FFdiv.csv')

with open(S_dir + 'mean_PSTHs-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(mean_PSTHs,f,pkl.HIGHEST_PROTOCOL)

with open(S_dir + 'vari_PSTHs-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(vari_PSTHs,f,pkl.HIGHEST_PROTOCOL)

# layer resolved
# SG
with open(S_dir + 'mean_PSTHs_SG-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(mean_PSTHs_SG,f,pkl.HIGHEST_PROTOCOL)
with open(S_dir + 'vari_PSTHs_SG-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(vari_PSTHs_SG,f,pkl.HIGHEST_PROTOCOL)
# G
with open(S_dir + 'mean_PSTHs_G-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(mean_PSTHs_G,f,pkl.HIGHEST_PROTOCOL)
with open(S_dir + 'vari_PSTHs_G-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(vari_PSTHs_G,f,pkl.HIGHEST_PROTOCOL)
# IG
with open(S_dir + 'mean_PSTHs_IG-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
    pkl.dump(mean_PSTHs_IG,f,pkl.HIGHEST_PROTOCOL)
with open(S_dir + 'vari_PSTHs_IG-MK-MU-Dec-2021-FFdiv.pkl','wb') as f:
